  ...
  server: {
    handlers: {
      GET: async () => {
        ...
        const content = `
# Workbench
> Personal engineering workspace: notes, conventions, project templates, and setup guides.

Guides are zero-to-working setup instructions. Conventions are decisions and rules.
